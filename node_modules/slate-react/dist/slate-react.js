(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('slate'), require('immutable'), require('react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'slate', 'immutable', 'react'], factory) :
	(factory((global.SlateReact = {}),global.Slate,global.Immutable,global.React));
}(this, (function (exports,slate,immutable,React) { 'use strict';
...
Leaf.propTypes = {
  annotations: ImmutablePropTypes_1.list.isRequired,
...
Text.propTypes = {
  annotations: ImmutablePropTypes_1.map.isRequired,
  block: Types.block,
  decorations: ImmutablePropTypes_1.list.isRequired,
  editor: propTypes.object.isRequired,
  node: Types.node.isRequired,
  ...
  createClass(Node, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (shouldUpdate != null) {
        index$2(false, 'As of slate-react@0.22 the `shouldNodeComponentUpdate` middleware is deprecated. You can pass specific values down the tree using React\'s built-in "context" construct instead.');
  ...
  if (startIndex === index) {
    ...
    if (child.object === 'text') {
      ...
      var _child$texts = child.texts(),
          _child$texts2 = slicedToArray$1(_child$texts, 1),
  ...
  if (endIndex === index) {
    ...
    if (child.object === 'text') {
      ...
      var _child$texts3 = child.texts({ direction: 'backward' }),
          _child$texts4 = slicedToArray$1(_child$texts3, 1),
...
debug$4.update = browser$1('slate:update');
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.tmp = {
      ...
      var window = getWindow_1(_this.ref.current);
      var native = window.getSelection();
      var activeElement = window.document.activeElement;


      if (debug$4.enabled) {
        debug$4.update('updateSelection', { selection: selection.toJSON() });
      }
      ...
      if (updated && debug$4.enabled) {
        debug$4('updateSelection', { selection: selection, native: native, activeElement: activeElement });
        debug$4.update('updateSelection-applied', { selection: selection });
      }
  ...
  createClass(Content, [{
    ...
    value: function componentDidCatch(error, info) {
      debug$4('componentDidCatch', { error: error, info: info });
    ...
    value: function componentDidMount() {
      var window = getWindow_1(this.ref.current);
    ...
    value: function componentDidUpdate() {
      debug$4.update('componentDidUpdate');
...
function SlateReactPlaceholder() {
  ...
  index$3(typeof placeholder === 'string', 'You must pass `SlateReactPlaceholder` an `options.placeholder` string.');

  index$3(typeof when === 'string' || typeof when === 'function', 'You must pass `SlateReactPlaceholder` an `options.when` query.');
  ...
  function decorateNode(node, editor, next) {
    ...
    var _node$texts = node.texts(),
        _node$texts2 = slicedToArray$2(_node$texts, 1),
        first = _node$texts2[0];

    var _node$texts3 = node.texts({ direction: 'backward' }),
        _node$texts4 = slicedToArray$2(_node$texts3, 1),
        last = _node$texts4[0];

    var _first = slicedToArray$2(first, 2),
        firstNode = _first[0],
        firstPath = _first[1];

    var _last = slicedToArray$2(last, 2),
        lastNode = _last[0],
        lastPath = _last[1];
  ...
  function renderMark(props, editor, next) {
    ...
    if (mark.type === 'placeholder' && mark.data.get('key') === instanceId) {
      var placeHolderStyle = _extends$1({
        pointerEvents: 'none',
...
function QueriesPlugin() {
  ...
  function findDOMRange(editor, range) {
    ...
    var window = getWindow_1(domAnchor.node);
  ...
  function findSelection(editor, domSelection) {
    ...
    if (anchorInline && !editor.isVoid(anchorInline) && anchor.offset === anchorText.text.length) {
      ...
      var _block$texts = block.texts({ path: relativePath }),
          _block$texts2 = slicedToArray$1(_block$texts, 1),
    ...
    if (focusInline && !editor.isVoid(focusInline) && focus.offset === focusText.text.length) {
      ...
      var _block$texts3 = _block.texts({ path: _relativePath }),
          _block$texts4 = slicedToArray$1(_block$texts3, 1),
          _next2 = _block$texts4[0];

      if (_next2) {
        var _next3 = slicedToArray$1(_next2, 2),
            _nextPath = _next3[1];
...
function findPoint(nativeNode, nativeOffset, editor) {
  index$2(false, 'As of slate-react@0.22 the `findPoint(node, offset)` helper is deprecated in favor of `editor.findPoint(node, offset)`.');
...
function normalizeNodeAndOffset$1(node, offset) {
  ...
  if (node.nodeType === 1 && node.childNodes.length) {
    ...
    node = getEditableChild$1(node, index$$1, direction);
...
function getEditableChild$1(parent, index$$1, direction) {
  var childNodes = parent.childNodes;
...
function findRange(native, editor) {
  index$2(false, 'As of slate-react@0.22 the `findRange(selection)` helper is deprecated in favor of `editor.findRange(selection)`.');
...
function getSelectionFromDOM(window, editor, domSelection) {
  index$2(false, 'As of slate-react@0.22 the `getSelectionFromDOM(window, editor, domSelection)` helper is deprecated in favor of `editor.findSelection(domSelection)`.');
...
var debug$5 = browser$1('slate:android');
debug$5.reconcile = browser$1('slate:reconcile');

debug$5('ANDROID_API_VERSION', { ANDROID_API_VERSION: ANDROID_API_VERSION });
...
function AndroidPlugin() {
      ...
      case 27:
        ...
        if (isNative) {
          if (event.inputType === 'insertParagraph' || event.inputType === 'insertLineBreak') {
            debug$5('onBeforeInput:enter:native', {});
            var domSelection = window.getSelection();
          ...
          if (isEnter) {
            ...
            window.requestAnimationFrame(function () {
              debug$5('onBeforeInput:enter:react', {});
  ...
  function onCompositionUpdate(event, editor, next) {
    debug$5('onCompositionUpdate', { event: event });
  }
    ...
    switch (ANDROID_API_VERSION) {
      ...
      case 28:
        ...
        if (nativeEvent.inputType === 'deleteContentBackward') {
          debug$5('onInput:delete', { keyDownSnapshot: keyDownSnapshot });
          var _window = getWindow_1(event.target);
          if (reconciler) reconciler.cancel();
          if (deleter) deleter.cancel();

          deleter = new Executor(_window, function () {
            debug$5('onInput:delete:callback', { keyDownSnapshot: keyDownSnapshot });
        ...
        if (ANDROID_API_VERSION === 28) {
          ...
          window.requestAnimationFrame(function () {
            debug$5('onInput:fallback:callback');
      ...
      case 27:
        if (event.key === 'Enter') {
          ...
          if (deleter) {
            ...
            window.requestAnimationFrame(function () {
              debug$5('onKeyDown:enter:callback');
              compositionEndSnapshot.apply(editor);
              editor.splitBlock();
            });
          } else {
      ...
      case 28:
        {
          ...
          debug$5('onKeyDown:snapshot', { keyDownSnapshot: keyDownSnapshot });
        }
  ...
  function onSelect(event, editor, next) {
    debug$5('onSelect', { event: event, status: status });
...
function findDOMNode(key) {
  ...
  index$2(false, 'As of slate-react@0.22 the `findDOMNode(key)` helper is deprecated in favor of `editor.findDOMNode(path)`.');
...
var debug$6 = browser$1('slate:after');
...
function AfterPlugin() {
      ...
      if (hasVoidParent) {
        ...
        while (hasVoidParent) {
          var _document$texts = document.texts({ path: p }),
              _document$texts2 = slicedToArray$1(_document$texts, 1),
          ...
          var _nxt = slicedToArray$1(nxt, 2);
  ...
  function onKeyDown(event, editor, next) {
    ...
    if (Hotkeys.isExtendBackward(event)) {
      ...
      var _document$texts3 = document.texts({
        ...
        direction: 'backward'
          ...
          _document$texts4 = slicedToArray$1(_document$texts3, 1),
          prevEntry = _document$texts4[0];

      var isPrevInVoid = false;

      if (prevEntry) {
        var _prevEntry = slicedToArray$1(prevEntry, 2),
    ...
    if (Hotkeys.isExtendForward(event)) {
      ...
      var _document$texts5 = document.texts({ path: start.path }),
          _document$texts6 = slicedToArray$1(_document$texts5, 1),
          nextEntry = _document$texts6[0];

      var isNextInVoid = false;

      if (nextEntry) {
        var _nextEntry = slicedToArray$1(nextEntry, 2),
  ...
  function onMouseDown(event, editor, next) {
    debug$6('onMouseDown', { event: event });
    isMouseDown = true;
    next();
  }
...
var debug$7 = browser$1('slate:before');
...
function BeforePlugin() {
  ...
  function onCompositionEnd(event, editor, next) {
    ...
    debug$7('onCompositionEnd', { event: event });
    next();
  }
  ...
  function onCompositionStart(event, editor, next) {
    ...
    debug$7('onCompositionStart', { event: event });
    next();
  }
  ...
  function onDragEnter(event, editor, next) {
    debug$7('onDragEnter', { event: event });
    next();
  }
  ...
  function onDragExit(event, editor, next) {
    debug$7('onDragExit', { event: event });
    next();
  }
  ...
  function onDragLeave(event, editor, next) {
    debug$7('onDragLeave', { event: event });
    next();
  }
...
var debug$8 = browser$1('slate:events');
...
var debug$9 = browser$1('slate:batch-events');
...
var debug$10 = browser$1('slate:mutations');
...
function DebugMutationsPlugin() {
  var observer = new window.MutationObserver(function (mutations) {
    ...
    debug$10.apply(undefined, [array.length + ' Mutations'].concat(toConsumableArray(array)));
  });
...
function ReactPlugin() {
  ...
  var debugEventsPlugin = browser$1.enabled('slate:events') ? DebugEventsPlugin(options) : null;
  var debugBatchEventsPlugin = browser$1.enabled('slate:batch-events') ? DebugBatchEventsPlugin(options) : null;
  var debugMutationsPlugin = browser$1.enabled('slate:mutations') ? DebugMutationsPlugin(options) : null;
  ...
  var placeholderPlugin = SlateReactPlaceholder({
...
var debug$11 = browser$1('slate:editor');
...
function findDOMPoint(point) {
  ...
  index$2(false, 'As of slate-react@0.22 the `findDOMPoint(point)` helper is deprecated in favor of `editor.findDOMPoint(point)`.');
...
function findDOMRange(range) {
  ...
  index$2(false, 'As of slate-react@0.22 the `findDOMRange(range)` helper is deprecated in favor of `editor.findDOMRange(range)`.');
...
function findNode(element, editor) {
  index$2(false, 'As of slate-react@0.22 the `findNode(element)` helper is deprecated in favor of `editor.findNode(element)`.');
...
function findPath(element, editor) {
  index$2(false, 'As of slate-react@0.22 the `findPath(element)` helper is deprecated in favor of `editor.findPath(element)`.');
...
function getEventRange(event, editor) {
  index$2(false, 'As of slate-react@0.22 the `getEventRange(event, editor)` helper is deprecated in favor of `editor.findEventRange(event)`.');
